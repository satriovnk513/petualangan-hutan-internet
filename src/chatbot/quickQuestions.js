 ...
 * dilengkapi emotikon pemanis yang ramah dan relevan:
...
export const QUICK_QUESTIONS_ID = [
  ...
  '🗺️ Kenapa internet diibaratkan seperti hutan?',
  ...
  '🛡️ Kenapa data pribadi adalah rahasia penting?',
  ...
  '🗝️ Bagaimana contoh password yang aman dan susah ditebak?',
  ...
  '🖼️ Apakah foto yang terlihat sangat nyata pasti benar?',
  '🤖 Apa itu gambar atau video buatan AI?',
...
export const QUICK_QUESTIONS_EN = [
  ...
  '🗺️ Why is the internet compared to a forest?',
  ...
  '🛡️ Why is personal data an important secret?',
  ...
  '🗝️ What makes a strong password that is hard to guess?',
  ...
  '🖼️ Does a realistic-looking photo mean it is definitely true?',
 ...
 * @param {number} count - Jumlah pertanyaan yang ingin ditampilkan (default 2)
 * @param {string[]} excludeList - Pertanyaan yang sedang tampil agar tidak muncul lagi
 * @returns {string[]}
 */
export function getRandomQuestions(lang = 'id', count = 2, excludeList = []) {
